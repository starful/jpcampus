---
{
  ...
  "description": "Download free PDF/Excel Japanese resume (Rirekisho) templates. Follow our step-by-step writing guide and examples to land your dream job in Japan!",
  "thumbnail": "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=500",
  "date": "2026-02-13",
  "seo_title": "How to Write a Japanese Resume (Rirekisho): 2025 Step-by-Step Guide",
  "seo_description": "Download free PDF/Excel Japanese resume (Rirekisho) templates. Follow our step-by-step writing guide and examples to land your dream job in Japan!"
}
---
...
### Education (Gakureki)
1.  **Start Point:** Usually, international students start from high school graduation.
2.  **Accuracy:** Write the official name of the school and the department/major. Do not abbreviate.
3.  **Entry/Exit:** For every school, you must have two lines: one for entering (入学 - nyugaku) and one for graduating (卒業 - sotsugyo).
    - *Example:* 
...
- **By Email:** Send it as a PDF. Name the file clearly: `20241020_Rirekisho_YourName.pdf`.
- **By Post:** Do not fold the Rirekisho if possible. Use a clear plastic folder (clear file) and place it inside a large white envelope (Kakugata 2 size). Write "履歴書在中" (Rirekisho enclosed) in red ink on the front of the envelope.
