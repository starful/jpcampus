...
1.  **Zairyu Card (Residence Card):** Essential, registered with your current Japanese address.
2.  **Valid Contact Information:** A working Japanese mobile phone number is almost always mandatory for security authentication.
3.  **Hanko (Inkan) or Signature:** While Yucho previously insisted on a personal stamp (Hanko/Inkan), they now widely accept signatures for foreigners, especially at larger post office branches. *Pro Tip: If you plan to live long-term, getting a cheap Katakana hanko is highly recommended, as it speeds up almost all future bureaucracy.*
...
1.  **Yucho:** Used as the cash management and daily expense account (easy withdrawals, local transfers).
2.  **A Megabank (MUFG):** Used for salary deposit, major transactions, and potentially international transfers, leveraging its slightly better online interface and corporate recognition.
