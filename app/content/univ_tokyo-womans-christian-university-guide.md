...
1.  **Examination for Japanese University Admission for International Students (EJU):** Applicants must submit their EJU scores. Specifically, the Japanese as a Foreign Language subject is mandatory, along with other subjects (Japan and the World, or Mathematics) depending on the chosen department.
2.  **JLPT (Optional but Recommended):** While EJU is the primary metric, having a JLPT N1 or N2 certificate can be advantageous.
3.  **University-Specific Examination:** This often includes an essay (小論文 - shōrunbun) written in Japanese and a rigorous interview with faculty members.
4.  **Application Period:** Generally, applications are accepted in late autumn (October/November) for April enrollment.
