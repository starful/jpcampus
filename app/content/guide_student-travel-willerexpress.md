---
{
  ...
  "title": "Budget Travel with Willer Express Highway Buses",
  "category": "Travel",
  "tags": [
    "Travel"
  ],
  "description": "Exploring Japan using overnight bus passes.",
...
1.  **Non-Transferable:** Only the person whose name is on the pass can use it.
2.  **No Repeat Routes on the Same Day:** You cannot book the same route twice in one day.
3.  **Booking Window:** You can book your seats up to several months in advance, which is highly recommended for popular routes like Tokyo-Osaka.
4.  **Seat Limitations:** The pass usually covers standard "Relax" seats. If you want to upgrade to a "Reborn" or "Luxia" seat, you typically have to pay a supplement or book outside the pass.
