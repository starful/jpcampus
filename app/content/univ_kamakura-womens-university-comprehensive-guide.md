...
1. **Japanese Proficiency:** Most departments require JLPT N2 or higher. Since lectures are conducted entirely in Japanese and involve technical terminology, a high level of fluency is essential.
2. **EJU (Examination for Japanese University Admission):** Scores in 'Japanese as a Foreign Language' are mandatory. Some departments may also look at 'Japan and the World' or 'Mathematics.'
3. **Internal Examination:** This usually consists of an essay (小論文, Shoronbun) in Japanese and a formal interview (面接, Mensetsu).
4. **Documents:** High school transcripts, graduation certificate, and a statement of purpose outlining why you chose Kamakura Women's University specifically.
...
## 💡 Final Verdict for International Students
