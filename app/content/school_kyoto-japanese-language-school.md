---
{
  ...
  "location": { "lat": 35.02638, "lng": 135.7576702 },
  "basic_info":
    {
      "name_ja": "京都日本語学校",
  ...
  "stats": { "international_students": 0, "capacity": 130 },
  "tuition": {},
  "faculties": [],
  "features":
    [
...
| -------------------------------------- | -------------- | ----------------------------------------------------------------------------------------------------------- |
| Nearest Train Station (Needs Research) | Unknown        | Requires investigation to identify the nearest train station.                                               |
...
Prospective students should contact Kyoto Japanese Language School directly to obtain detailed information about the curriculum, accommodation options, tuition fees, and available scholarships to make an informed decision about their Japanese language education.
