...
1.  **7-Eleven (Seven Bank):** Generally considered the most reliable for foreign cards. They have high withdrawal limits and a very clear English interface.
2.  **Lawson (Lawson Bank):** Also very reliable and supports a wide range of international networks (Plus, Cirrus).
3.  **FamilyMart (E-net):** These work well, but sometimes the "Administrative Fee" for foreign cards is slightly higher (around ¥220 per transaction).
