---
{
  ...
  "title": "Joining the Rakuten Ecosystem for Points",
  "category": "Budget",
  "tags": [
    "Budget"
  ],
  "description": "Using Rakuten Card, Mobile, and Ichiba to save money.",
...
1. **Shopping Marathons (Okaimono Marathon):** These happen once or twice a month. For every different shop you buy from (minimum 1,000 yen purchase), your point multiplier increases by +1x, up to +10x. If you need five different items, buy them all during the Marathon at five different "shops" within Rakuten Ichiba to get 5% extra back on everything.
2. **The "5 and 0" Rule:** On dates ending in 5 or 0 (5th, 10th, 15th, 20th, 25th, 30th), you get an extra **+1% to +2%** if you use your Rakuten Card. Always wait for these days to clear your cart.
3. **Rakuten Eagles & Vissel Kobe Wins:** If Rakuten’s professional sports teams win a game, points are often doubled (+1%) the following day. Look for the banners on the homepage and click "Entry" to activate.
